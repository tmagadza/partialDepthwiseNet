...
from .classification import custom, isensee, nnunet
from .segmentation import unet, separable_unet, se_separable_unet, se_sepnet, attention
from . import graph
...
def fetch_model_by_name(model_name, *args, **kwargs):
    try:
        ...
        elif "unet" == model_name.lower():
            return getattr(unet, model_name)(*args, **kwargs)
        elif "separableunet" == model_name.lower():
            return getattr(separable_unet, model_name)(*args, **kwargs)
        elif "seseparableunet"  ==  model_name.lower():
            return getattr(se_separable_unet, model_name)(*args, **kwargs)
        elif "sesepnet"  ==  model_name.lower():
            return getattr(se_sepnet, model_name)(*args, **kwargs)
        elif "isensee"  in  model_name.lower():
            return getattr(isensee, model_name)(*args, **kwargs)
        elif "nnunet"  in  model_name.lower():
            return getattr(nnunet, model_name)(*args, **kwargs)

        elif "attention"  in  model_name.lower():
            return getattr(attention, model_name)(*args, **kwargs)
        else:
