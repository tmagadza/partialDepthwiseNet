...
def build_optimizer(optimizer_name, model_parameters, learning_rate=1e-4, weight_decay=0):
    return getattr(torch.optim, optimizer_name)(model_parameters, lr=learning_rate, weight_decay=weight_decay)
